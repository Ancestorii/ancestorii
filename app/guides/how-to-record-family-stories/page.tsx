...
export const metadata: Metadata = {
  title: 'How to Record Family Stories | Ancestorii',
  description:
    'Learn how to record family stories in a simple, meaningful way. A guide to preserving personal stories so future generations understand more than names and dates.',
  alternates: {
