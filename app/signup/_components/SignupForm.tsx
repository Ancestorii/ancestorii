...
<button
  ...
  className="w-full mt-5 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-full border border-gray-300 bg-white hover:bg-gray-50 transition"
>
  <svg
  ...
  <div className="flex-grow h-px bg-gray-200" />
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-5">
        ...
        <div className="flex items-center gap-3 text-xs sm:text-sm whitespace-nowrap">
          ...
          />
          Send me updates on preserving family memories
        </div>
