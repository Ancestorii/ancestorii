    ...
    >
      ...
      <div className="flex justify-center mb-5">
        {member.avatar_signed ? (
          <div className="w-[100px] h-[100px] rounded-full overflow-hidden border-4 border-[#E6C26E] shadow-md">
            <Image
          ...
          <div className="w-[100px] h-[100px] rounded-full bg-violet-200
      ...
      {/* Name */}
      <h2 className={`text-xl font-semibold ${TEXT_PRIMARY} text-center tracking-wide leading-snug`}>
        {member.full_name}
      </h2>
